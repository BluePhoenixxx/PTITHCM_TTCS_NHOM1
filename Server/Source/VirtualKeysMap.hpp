#ifndef VIRTUALKEYSMAP
#define VIRTUALKEYSMAP
...
//Map giá trị tương ứng với các key trên bàn phím
std::unordered_map<int, std::string> virtualKeysMap = {
    ...
    {0x59, "Y"},
    {0x5A, "Z"},
    {0x5B, "Left Windows (Natural keyboard)"},
    {0x5C, "Right Windows (Natural keyboard)"},
    {0x5D, "Applications (Natural keyboard)"},
    {0x5E, "Reserved"},
    {0x5F, "Computer Sleep"},
    ...
    {0xBA, "The ';:' key on us Standard Keyboards"},
    ...
    {0xE0, "Reserved"},
    {0xE1, "OEM specific"},
    {0xE2, "Either the angle bracket key or the backslash key on the RT "
           "102-key keyboard"},
    {0xE5, "IME PROCESS"},
    {0xE6, "OEM specific"},
    {0xE8, "Unassigned"},
